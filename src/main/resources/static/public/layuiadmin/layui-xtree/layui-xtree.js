    ...
    if (d.length > 0) {
        for (i in d) {
            ...
            if (d[i].data.length > 0)
                _this._domStr += '<i class="layui-icon layui-xtree-icon '+ (_this._isopen ? _this._iconOpen : _this._iconClose) + '" data-xtree="' + (_this._isopen ? '1' : '0') + '"></i>';
            else {
    ...
    for (var i = 0; i < xtree_icons.length; i++) {
        ...
        xtree_icons[i].onclick = function () {
            ...
            if (this.getAttribute('data-xtree') == 1) {
                ...
                this.className = this.className.replace(_this._iconOpen,_this._iconClose);
                ...
                this.className = this.className.replace(_this._iconClose,_this._iconOpen);
